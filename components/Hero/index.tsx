...
const Hero = () => {
  return (
    <>
      ...
      >
        <div className="absolute left-0 right-0 top-0  -z-50 h-full overflow-hidden bg-black ">
          <Image
            src={"/images/hero/backdrop.jpg"}
            alt="backdrop"
            fill
            className="-z-40 opacity-50 blur-[16px]"
          />
        </div>
            ...
            <div className="w-full px-4">
              ...
              >
                <h1 className="mb-5 text-3xl font-bold leading-tight text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
                  Transforming Businesess through end to end IT solutions
                </h1>
